...
/**
 * @description try to install program to GUI
 *
 * @author molinchang
 */
@Component
...
//        pack();
    ...
    private JPanel initShowAllCategoryPanel() {
        ...
        JLabel viewLabel = new JLabel("全部分类条目如下: ");
        ...
        confirmBtn.addActionListener(l -> {
            ...
            try {
                ...
                if (add) {
                    ...
                    System.out.println(SystemWarnLanguageEnum.ADD_SUCCEED.getContent());
                    // clear panel and reset value
                    jTextArea.setText(null);
                    List<Category> search = manager.subShowCategoryView();
                    search.forEach(c -> {
                    ...
                    System.out.println(SystemWarnLanguageEnum.ADD_FAILED.getContent());
                    nameField.setText(null);
                }
    ...
    private JPanel initDeleteCategoryPanel() {
        ...
        confirmBtn.addActionListener(l -> {
            ...
            if (delete) {
                ...
                System.out.println(SystemWarnLanguageEnum.DELETE_SUCCEED.getContent());
                // clear panel and reset value
                jTextArea.setText(null);
                List<Category> search = manager.subShowCategoryView();
                search.forEach(c -> {
                ...
                System.out.println(SystemWarnLanguageEnum.DELETE_FAILED.getContent());
                nameField.setText(null);
            }
...
//        JPanel unionGruop = new JPanel();
//        Box checkBoxGroup = Box.createVerticalBox();
        ...
        // add jTable to instead of text area
        String[] columnNames = new String[] {"","sql","key"};
//        String[][] rowData = GuiUtils.createRowByData()
        JTable jTable = new JTable();
//        unionGruop.add(checkBoxGroup);
//        unionGruop.add(addableTextArea);
...
//                    checkBoxGroup.add(checkBox);
    ...
    private JPanel initAddSQLPanel() {
        ...
        JButton refreshBtn = generateSqlRefreshBtn(jTextArea, 100);
    ...
    private JButton generateSqlRefreshBtn(JTextArea jTextArea, int width) {
        JButton refreshBtn = new JButton();
        refreshBtn.setIcon(new FlatRadioButtonIcon());
        refreshBtn.setFocusPainted(false);
        refreshBtn.setBorderPainted(false);
...
//        SVGButton refreshButton = button.generateSVGButton(null);
